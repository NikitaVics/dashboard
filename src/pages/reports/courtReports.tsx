...
function CourtReportDetails() {
    ...
    const { data : dropdownData } = useSWR(
      `/api/reports/courtDropdown`
    )
...
<Flex
    ...
    >
   <Select placeholder='courts' w={{md:"165px"}} onChange={handleSelectChange} bgColor={bgColor2}>
...
{selected && (
        <IconButton onClick={handleClearCourt} color="red.400"  aria-label={""} bg="none">
          <CloseButton />
        </IconButton>
      )}

     <Button   py={3} w={{md:"165px"}} onClick={handleExport} variant="outline" color="green.400" borderColor="green.400" rightIcon={<DownloadIcon />}>
