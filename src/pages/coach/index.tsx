import { Avatar, Flex, HStack,  IconButton, Menu, MenuButton, MenuItem, MenuList, 
Text,
useColorModeValue,
Box,
Stack,
  ...
  const isLoading = !coachData
    return (
      ...
      <DrawerContent bgColor={color}>
        ...
        <DrawerHeader fontSize="28px" fontWeight="700">{t(`coach.addTitle`)}</DrawerHeader>
    ...
    {isEditModalOpen && (
              <><CoachForm
                    ...
                    onClose={() => setIsEditModalOpen(false)} coachId={coachId} coachData={coaches} /></>
              )}
            </Stack>
          </PageContainer>
        )}
