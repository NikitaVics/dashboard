  ...
  return (
    <chakra.div display="flex" alignItems="center" width="40px" height="40px" {...props}>
      ...
      <svg width="9" height="19" viewBox="0 0 9 19" fill="none">
        <defs>
          <linearGradient id="paint0_linear_2998_591" x1="0.5" y1="9" x2="9" y2="9" gradientUnits="userSpaceOnUse">
            <stop stopColor="#62D181" />
            <stop offset="1" stopColor="#62D181" stopOpacity="0" />
          </linearGradient>
        </defs>
        <path d="M0.5 4.22222L8.5 0V19L0.5 14.7778V4.22222Z" fill="url(#paint0_linear_2998_591)" />
      </svg>
    </chakra.div>
  );
};
