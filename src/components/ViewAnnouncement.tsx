...
import GeneralAnnouncement from "./Forms/viewAnnouncement";
...
const ViewAnnouncement = (props: Announcement) => {
  ...
  return (
   ...
   <GeneralAnnouncement message={undefined} onClose={onClose} id={id} Data={responseData}  />
          )}
        </DrawerBody>
      </DrawerContent>
    </Drawer>
