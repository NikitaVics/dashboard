...
import { useColorModeValue, Drawer, DrawerOverlay, DrawerContent, DrawerCloseButton, DrawerHeader,Text, DrawerBody, Flex, Stack } from "@chakra-ui/react";
          ...
          <DrawerBody maxW="full">
            <Flex direction="column" justify="center" align="center" h="80%" gap={8}>
              ...
              <Stack textAlign={"center"} px={20}>
                <Text fontSize={"32px"} fontWeight={"700"} color="rgba(78, 203, 113, 1)">
                  {t(`announce.schedule`)}{" "}
                </Text>
